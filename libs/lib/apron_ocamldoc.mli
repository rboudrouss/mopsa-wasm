...
module Linexpr0 : sig
  ...
  *)
  ...
  (** Comparison with lexicographic ordering using [Coeff.cmp], terminating by constant. This is a partial ordrer; as [Coeff.cmp] it returns an integer between -3 and 3. It cannot be used when a total order is required (e.g., in [Set.Make]).*)
  external cmp : t -> t -> int
  	= "camlidl_linexpr0_ap_linexpr0_cmp"
  
  (** Equality comparison *)
  external equal : t -> t -> bool
  	= "camlidl_linexpr0_ap_linexpr0_equal"
...
module Texpr0 : sig
  ...
  *)
  ...
  (** Equality test *)
  external equal : t -> t -> bool
  	= "camlidl_texpr0_ap_texpr0_equal"
  
  (** Hashing function *)
  external hash : t -> int
  	= "camlidl_texpr0_ap_texpr0_hash"
...
module Environment : sig
  ...
  *)
  ...
  external cmp : t -> t -> int
  	= "camlidl_environment_ap_environment_cmp"
...
(** {2 Module [ Version]: APRON version} *)

module Version : sig
  
  (* This file is part of the APRON Library, released under LGPL license with an exception allowing the redistribution of statically linked executables.
     Please read the COPYING file packaged in the distribution *)
  (* File generated from version.idl *)
  
  
  (** APRON version *)
  external version : unit -> string
  	= "camlidl_version_version"
  
  external version_major : unit -> int
  	= "camlidl_version_version_major"
  
  external version_minor : unit -> int
  	= "camlidl_version_version_minor"
  
  external version_micro : unit -> int
  	= "camlidl_version_version_micro"
