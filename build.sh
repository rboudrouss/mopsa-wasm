...
ocamlmklib -oc camlstr strstubs.o
ocamlc -c -absname -w +a-4-9-41-42-44-45-48 -warn-error A -bin-annot -g -safe-string -strict-sequence -strict-formats  str.mli
ocamlc -c -absname -w +a-4-9-41-42-44-45-48 -warn-error A -bin-annot -g -safe-string -strict-sequence -strict-formats  str.ml
ocamlmklib -o str -oc camlstr -linkall str.cmo
...
ocamlc -c -absname -w +a-4-9-41-42-44-45-48 -warn-error A -bin-annot -g -safe-string -strict-sequence -strict-formats -nolabels unix.mli
ocamlc -c -absname -w +a-4-9-41-42-44-45-48 -warn-error A -bin-annot -g -safe-string -strict-sequence -strict-formats -nolabels unix.ml
ocamlc -c -absname -w +a-4-9-41-42-44-45-48 -warn-error A -bin-annot -g -safe-string -strict-sequence -strict-formats -nolabels -pp "gawk -f ../../stdlib/expand_module_aliases.awk" unixLabels.mli
ocamlc -c -absname -w +a-4-9-41-42-44-45-48 -warn-error A -bin-annot -g -safe-string -strict-sequence -strict-formats -nolabels unixLabels.ml
ocamlmklib -o unix -oc unix -linkall unix.cmo unixLabels.cmo
...
MPFR_PREFIX=${installFolder} GMP_PREFIX=${installFolder} emconfigure ./configure -no-java -no-cxx -no-ppl -no-pplite -prefix ${installFolder}


# -i to ignore error cause it calls sometimes ocamlopt
make -i
# BEWARE this write things to opam directory ()
make install -i

# may need to reinstall apron in opam
# needed to build the mopsa.bc later
opam remove apron
opam install apron

cd ..

cp ~/.opam/4.12.0/lib/apron/* libs/lib
...
cp ocaml-wasm/runtime/libcamlrun.a build/
